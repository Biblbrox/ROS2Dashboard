...
{
#ifdef _WIN32
    return Platform::p_win32;
#elif _WIN64
    return Platform::p_win64;
#elif __APPLE__ || __MACH__
    return Platform::p_macosx;
#elif __linux__
    return Platform::p_linux;
#elif __FreeBSD__
    return Platform::p_freebsd;
#elif __unix || __unix__
    return Platform::p_unix;
#else
    return Platform::p_other;
#endif
}
...
constexpr Compiler getCompiler()
{
    ...
    return Compiler::c_gcc;
#endif

#ifdef __clang__//clang
    return Compiler::c_clang;
#endif

#ifdef _MSC_VER
    return Compiler::c_msvc;
#endif
}
